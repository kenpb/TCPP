...
namespace ClientLauncher
{
    ...
    void do_patches(Patcher* patcher)
    {
    ...
    bool LaunchGame(boost::filesystem::path binaryDir, std::vector<std::string> const& args)
    {
        ...
        std::cout << "Starting process for file: " << commandLine << std::endl;
        ...
        std::cout << "Successfully started process" << std::endl;
        ...
        */
        ...
        do_patches<Patches::Windows::x86, Patterns::Windows::x86>(&patcher);
#else
        std::cout << "Win64 client...\n";
        do_patches<Patches::Windows::x64, Patterns::Windows::x64>(&patcher);
#endif
